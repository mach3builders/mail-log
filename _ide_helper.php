...
')
     ...
     */ 
        ...
        {
                        /** @var \Mach3builders\Ui\Alert $instance */
                        return $instance->message($message, $type);
        }
                    /**
         ...
         * @static 
         */ 
        public static function dismissible($dismissible = true)
        {
                        /** @var \Mach3builders\Ui\Alert $instance */
                        return $instance->dismissible($dismissible);
        }
                    /**
     ...
     */ 
        ...
        public static function message($message, $type = 'info')
        {
                        /** @var \Mach3builders\Ui\Notify $instance */
                        return $instance->message($message, $type);
        }
                    /**
     ...
     */ 
         ...
         * @static 
         */ 
        public static function message($message, $type = 'success', $title = null)
        {
                        /** @var \Mach3builders\Ui\Toast $instance */
...
namespace  { 
            ...
            {
                                return \Illuminate\Database\Query\Builder::search($attributes);
            }
             ...
             * @static 
             */ 
            public static function filter($allowed_filters)
            {
                                return \Illuminate\Database\Query\Builder::filter($allowed_filters);
            }
                    }
            ...
            class Askwise extends \App\Askwise {}
            ...
            class Alert extends \Mach3builders\Ui\Facades\Alert {}
            class Notify extends \Mach3builders\Ui\Facades\Notify {}
            class Toast extends \Mach3builders\Ui\Facades\Toast {}
